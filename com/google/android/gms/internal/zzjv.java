...
public interface zzjv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzjv {
        ...
        private static class zza implements zzjv {
        ...
        public static zzjv zzP(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzjv)) ? new zza(iBinder) : (zzjv) queryLocalInterface;
        }
    ...
    int zzgH() throws RemoteException;
}
