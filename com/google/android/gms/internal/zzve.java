...
public interface zzve extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzve {

        private static class zza implements zzve {
        ...
        public static zzve zzaF(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzve)) ? new zza(iBinder) : (zzve) queryLocalInterface;
        }
