...
public interface zzuq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzuq {
        ...
        private static class zza implements zzuq {
        ...
        public static zzuq zzaC(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzuq)) ? new zza(iBinder) : (zzuq) queryLocalInterface;
        }
