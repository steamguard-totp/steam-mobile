...
public class zzaac implements zzaau {
    ...
    public void connect() {
        ...
        try {
            if (!this.zzazy) {
                ...
                this.zzazz = null;
                this.zzazA = null;
                Object com_google_android_gms_internal_zzaac_zza = new zza();
                Executor com_google_android_gms_internal_zzact = new zzact(this.zzrx);
                this.zzaxK.zza(this.zzazt.values()).addOnSuccessListener(com_google_android_gms_internal_zzact, com_google_android_gms_internal_zzaac_zza).addOnFailureListener(com_google_android_gms_internal_zzact, com_google_android_gms_internal_zzaac_zza);
                this.zzazn.unlock();
            }
        } finally {
            this.zzazn.unlock();
    ...
    public <A extends Api.zzb, T extends com.google.android.gms.internal.zzzv.zza<? extends Result, A>> T zzb(T t) {
        this.zzazv.zzaAx.zzb(t);
        return ((com.google.android.gms.common.api.zzc) this.zzazt.get(t.zzuH())).doWrite(t);
    }
