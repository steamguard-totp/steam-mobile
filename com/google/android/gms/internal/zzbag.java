...
public class zzbag extends zzazv {
    protected zzbfw<?> zza(zzazg com_google_android_gms_internal_zzazg, zzbfw<?>... com_google_android_gms_internal_zzbfw_Arr) {
        ...
        if (com_google_android_gms_internal_zzbfw_Arr.length == 3) {
            ...
            zzac.zzar(size > 0);
            zzbfw<?> zzna = com_google_android_gms_internal_zzbgb.zzna(0);
            int i2 = 1;
            i = 0;
            while (i < size) {
        ...
        int i3 = i;
        while (i3 < size && i3 < ((List) com_google_android_gms_internal_zzbgb.zzRF()).size()) {
