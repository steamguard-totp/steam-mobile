...
public class zzazz extends zzazv {
    protected zzbfw<?> zza(zzazg com_google_android_gms_internal_zzazg, zzbfw<?>... com_google_android_gms_internal_zzbfw_Arr) {
        ...
        while (i < size && i < ((List) com_google_android_gms_internal_zzbgb.zzRF()).size()) {
            if (com_google_android_gms_internal_zzbgb.zznb(i)) {
                ((zzazt) com_google_android_gms_internal_zzbfz.zzRF()).zzb(com_google_android_gms_internal_zzazg, (zzbfw) r2.get(i), new zzbfy(Double.valueOf((double) i)), com_google_android_gms_internal_zzbgb);
            }
            i++;
        }
        return zzbga.zzbKV;
