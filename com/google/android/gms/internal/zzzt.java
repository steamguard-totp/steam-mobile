...
public class zzzt extends zzzw {
    ...
    private class zza implements OnConnectionFailedListener {
        ...
        public void onConnectionFailed(ConnectionResult connectionResult) {
            ...
            new StringBuilder(String.valueOf(valueOf).length() + 27).append("beginFailureResolution for ").append(valueOf).toString();
    ...
    public void onStart() {
        ...
        new StringBuilder(String.valueOf(valueOf).length() + 14).append("onStart ").append(z).append(" ").append(valueOf).toString();
        if (!this.zzayG) {
            for (int i = 0; i < this.zzayx.size(); i++) {
    ...
    public void zza(int i, GoogleApiClient googleApiClient, OnConnectionFailedListener onConnectionFailedListener) {
        ...
        "starting AutoManage for client " + i + " " + this.mStarted + " " + this.zzayG;
        ...
        if (this.mStarted && !this.zzayG) {
            ...
            new StringBuilder(String.valueOf(valueOf).length() + 11).append("connecting ").append(valueOf).toString();
