...
public interface zzvk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzvk {
        ...
        private static class zza implements zzvk {
        ...
        public static zzvk zzaI(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.internal.IAuthCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzvk)) ? new zza(iBinder) : (zzvk) queryLocalInterface;
        }
