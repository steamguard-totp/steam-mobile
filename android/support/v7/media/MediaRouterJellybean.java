...
final class MediaRouterJellybean {
    ...
    static class CallbackProxy<T extends Callback> extends android.media.MediaRouter.Callback {
        ...
        public void onRouteGrouped(MediaRouter router, android.media.MediaRouter.RouteInfo route, RouteGroup group, int index) {
        }

        public void onRouteUngrouped(MediaRouter router, android.media.MediaRouter.RouteInfo route, RouteGroup group) {
        }
    ...
    public static Object createUserRoute(Object routerObj, Object categoryObj) {
        return ((MediaRouter) routerObj).createUserRoute((RouteCategory) categoryObj);
    }
