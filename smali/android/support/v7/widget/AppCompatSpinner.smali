...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput-object v7, p0, Landroid/support/v7/widget/AppCompatSpinner;->mTempRect:Landroid/graphics/Rect;
    ...
    new-instance v7, Landroid/support/v7/widget/AppCompatBackgroundHelper;

    invoke-direct {v7, p0}, Landroid/support/v7/widget/AppCompatBackgroundHelper;-><init>(Landroid/view/View;)V

    iput-object v7, p0, Landroid/support/v7/widget/AppCompatSpinner;->mBackgroundTintHelper:Landroid/support/v7/widget/AppCompatBackgroundHelper;
    ...
    invoke-direct {v7, p1, p5}, Landroid/support/v7/view/ContextThemeWrapper;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V

    iput-object v7, p0, Landroid/support/v7/widget/AppCompatSpinner;->mPopupContext:Landroid/content/Context;

    .line 215
    :goto_0
    iget-object v7, p0, Landroid/support/v7/widget/AppCompatSpinner;->mPopupContext:Landroid/content/Context;
    ...
    :try_start_0
    sget-object v7, Landroid/support/v7/widget/AppCompatSpinner;->ATTRS_ANDROID_SPINNERMODE:[I
    ...
    .line 240
    new-instance v5, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;

    iget-object v7, p0, Landroid/support/v7/widget/AppCompatSpinner;->mPopupContext:Landroid/content/Context;

    invoke-direct {v5, p0, v7, p2, p3}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;-><init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 241
    .local v5, "popup":Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;
    iget-object v7, p0, Landroid/support/v7/widget/AppCompatSpinner;->mPopupContext:Landroid/content/Context;

    sget-object v8, Landroid/support/v7/appcompat/R$styleable;->Spinner:[I

    const/4 v9, 0x0

    invoke-static {v7, p2, v8, p3, v9}, Landroid/support/v7/widget/TintTypedArray;->obtainStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/TintTypedArray;

    move-result-object v4

    .line 243
    .local v4, "pa":Landroid/support/v7/widget/TintTypedArray;
    sget v7, Landroid/support/v7/appcompat/R$styleable;->Spinner_android_dropDownWidth:I

    const/4 v8, -0x2

    invoke-virtual {v4, v7, v8}, Landroid/support/v7/widget/TintTypedArray;->getLayoutDimension(II)I

    move-result v7

    iput v7, p0, Landroid/support/v7/widget/AppCompatSpinner;->mDropDownWidth:I

    .line 245
    sget v7, Landroid/support/v7/appcompat/R$styleable;->Spinner_android_popupBackground:I

    .line 246
    invoke-virtual {v4, v7}, Landroid/support/v7/widget/TintTypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v7

    .line 245
    invoke-virtual {v5, v7}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V

    .line 247
    sget v7, Landroid/support/v7/appcompat/R$styleable;->Spinner_android_prompt:I

    invoke-virtual {v0, v7}, Landroid/support/v7/widget/TintTypedArray;->getString(I)Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v5, v7}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->setPromptText(Ljava/lang/CharSequence;)V

    .line 248
    invoke-virtual {v4}, Landroid/support/v7/widget/TintTypedArray;->recycle()V

    .line 250
    iput-object v5, p0, Landroid/support/v7/widget/AppCompatSpinner;->mPopup:Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;

    .line 251
    new-instance v7, Landroid/support/v7/widget/AppCompatSpinner$1;

    invoke-direct {v7, p0, p0, v5}, Landroid/support/v7/widget/AppCompatSpinner$1;-><init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/view/View;Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;)V

    iput-object v7, p0, Landroid/support/v7/widget/AppCompatSpinner;->mForwardingListener:Landroid/support/v7/widget/ForwardingListener;

    .line 268
    .end local v4    # "pa":Landroid/support/v7/widget/TintTypedArray;
    .end local v5    # "popup":Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;
    :cond_2
    sget v7, Landroid/support/v7/appcompat/R$styleable;->Spinner_android_entries:I

    invoke-virtual {v0, v7}, Landroid/support/v7/widget/TintTypedArray;->getTextArray(I)[Ljava/lang/CharSequence;
    ...
    sget v7, Landroid/support/v7/appcompat/R$layout;->support_simple_spinner_dropdown_item:I
    ...
    .line 282
    iget-object v7, p0, Landroid/support/v7/widget/AppCompatSpinner;->mTempAdapter:Landroid/widget/SpinnerAdapter;
    ...
    invoke-virtual {p0, v7}, Landroid/support/v7/widget/AppCompatSpinner;->setAdapter(Landroid/widget/SpinnerAdapter;)V

    .line 284
    const/4 v7, 0x0

    iput-object v7, p0, Landroid/support/v7/widget/AppCompatSpinner;->mTempAdapter:Landroid/widget/SpinnerAdapter;

    .line 287
    :cond_4
    iget-object v7, p0, Landroid/support/v7/widget/AppCompatSpinner;->mBackgroundTintHelper:Landroid/support/v7/widget/AppCompatBackgroundHelper;

    invoke-virtual {v7, p2, p3}, Landroid/support/v7/widget/AppCompatBackgroundHelper;->loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    :cond_5
    sget v7, Landroid/support/v7/appcompat/R$styleable;->Spinner_popupTheme:I
    ...
    invoke-direct {v7, p1, v6}, Landroid/support/v7/view/ContextThemeWrapper;-><init>(Landroid/content/Context;I)V
