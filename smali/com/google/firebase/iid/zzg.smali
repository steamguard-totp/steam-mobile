...
# static fields
.field private static zzcje:Lcom/google/firebase/iid/zzg;


# instance fields
.field private final zzcjf:Landroid/support/v4/util/SimpleArrayMap;
...
.field private zzcjg:Ljava/lang/Boolean;

.field final zzcjh:Ljava/util/Queue;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Queue",
            "<",
...
.field final zzcji:Ljava/util/Queue;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Queue",
            "<",
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzg;->zzcjf:Landroid/support/v4/util/SimpleArrayMap;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/firebase/iid/zzg;->zzcjg:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzg;->zzcjh:Ljava/util/Queue;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzg;->zzcji:Ljava/util/Queue;
...
.method public static declared-synchronized zzaaj()Lcom/google/firebase/iid/zzg;
    .locals 2
    ...
    :try_start_0
    sget-object v0, Lcom/google/firebase/iid/zzg;->zzcje:Lcom/google/firebase/iid/zzg;
    ...
    sput-object v0, Lcom/google/firebase/iid/zzg;->zzcje:Lcom/google/firebase/iid/zzg;
...
.method private zzbY(Landroid/content/Context;)Z
    .locals 1

    iget-object v0, p0, Lcom/google/firebase/iid/zzg;->zzcjg:Ljava/lang/Boolean;
...
.method private zze(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iget-object v1, p0, Lcom/google/firebase/iid/zzg;->zzcjf:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzg;->zzcjf:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :try_start_2
    iget-object v2, p0, Lcom/google/firebase/iid/zzg;->zzcjf:Landroid/support/v4/util/SimpleArrayMap;
...
.method private zzg(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    :try_start_0
    invoke-direct {p0, p1}, Lcom/google/firebase/iid/zzg;->zzbY(Landroid/content/Context;)Z
...
# virtual methods
.method public zzaak()Landroid/content/Intent;
    .locals 1

    iget-object v0, p0, Lcom/google/firebase/iid/zzg;->zzcjh:Ljava/util/Queue;
...
.method public zzaal()Landroid/content/Intent;
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/zzg;->zzcji:Ljava/util/Queue;
