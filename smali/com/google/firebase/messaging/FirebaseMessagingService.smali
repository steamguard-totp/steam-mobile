...
.method private zzK(Landroid/content/Intent;)V
    .locals 2
    ...
    invoke-static {v0}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzW(Landroid/os/Bundle;)Z
...
.method private zzn(Landroid/content/Intent;)V
    ...
    invoke-static {p0, p1}, Lcom/google/firebase/messaging/zzb;->zzi(Landroid/content/Context;Landroid/content/Intent;)V
...
.method private zzo(Landroid/content/Intent;)V
    ...
    invoke-static {p0}, Lcom/google/firebase/messaging/zza;->zzbc(Landroid/content/Context;)Z

    move-result v1

    if-nez v1, :cond_0

    invoke-static {p0}, Lcom/google/firebase/messaging/zza;->zzca(Landroid/content/Context;)Lcom/google/firebase/messaging/zza;

    move-result-object v1

    invoke-virtual {v1, v0}, Lcom/google/firebase/messaging/zza;->zzT(Landroid/os/Bundle;)V
...
.method protected zzF(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-virtual {v0}, Lcom/google/firebase/iid/zzg;->zzaal()Landroid/content/Intent;
...
.method public zzH(Landroid/content/Intent;)Z
    ...
    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzK(Landroid/content/Intent;)V
